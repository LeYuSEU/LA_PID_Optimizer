...
save_file = f'./result/PID_dataset/CIFAR10_PID I={I} D={D} lr={learning_rate}.txt'
...
if __name__ == '__main__':
    ...
    train_dataset = dsets.CIFAR10(root='../PIDoptimizer/data', train=True, transform=transforms.ToTensor(), download=True)
    test_dataset = dsets.CIFAR10(root='../PIDoptimizer/data', train=False, transform=transforms.ToTensor())
